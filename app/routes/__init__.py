...
routes = Blueprint.group(event_options, events, groups, invites, me, messages, user_and_group, user_event_option_response, user_vote_option_response, users, vote_options, votes, url_prefix="/api")